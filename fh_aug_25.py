...
support_unique = [
    ...
    'MAP/PCP appt', 
    'PCP COMPLETED', 
    "MAP ( wasn't able to submit application)",
    'MAP Appt',
    'Primary care', 
    'Primary care referral',
    'Primary care physician',
    'PCP appointment & MAP application', 'PCP appt', 
    'Dental Appointment', 
    'MAP/PCP @BMHC', 
    'Transportation',
    'PCP', 
    'MAP & Same day pcp appt',
    'MAP Application',
    'New patient appt',
    'Appt COMPLETED', 
    'New Patient appt COMPLETED', 
    'New patient appt COMPLETED',
    'New Patient appT',
    'Mental Health Appointment', 
    'Referred BAP', 
    'New pt appt COMPLETED', 
    'New Pt appt COMPLETED', 
    'Appt 08/12'
]
...
df['Support'] = (
    df['Support']
        ...
        .replace({
            ...
            "MAP Appt": "MAP appt",
            "MAP appt": "MAP appt",
            "MAP/PCP appt": "MAP + PCP appt",
            "MAP/PCP @BMHC": "MAP + PCP appt",
            "MAP ( wasn't able to submit application)": "MAP appt",
            "MAP & Same day pcp appt": "MAP + PCP appt",

            # PCP variations
            "PCP appointment": "PCP appt",
            "PCP": "PCP appt",
            "Scheduled appt": "PCP appt",
            "PCP appt": "PCP appt",
            "Primary care": "PCP appt",
            "Primary care referral": "PCP appt",
            "Primary care physician": "PCP appt",
            "PCP COMPLETED": "PCP appt",
            "PCP appointment & MAP application": "MAP + PCP appt",

            # Appointment completions
            "Appt COMPLETED": "Appt completed",
            "New patient appt": "New patient appt",
            "New Patient appt COMPLETED": "New patient appt",
            "New patient appt COMPLETED": "New patient appt",
            "New patient appt COMPLETED": "New patient appt",
            "New Patient appT": "New patient appt",
            "New pt appt COMPLETED": "New patient appt",
            "New Pt appt COMPLETED": "New patient appt",
            "Appt 08/12": "Scheduled appt",  # could keep as-is if important

            # Other support
            "Dental Appointment": "Dental appt",
            "Transportation support": "Transportation",
            "Transportation": "Transportation",
            "Ride Coordination": "Transportation",
            "Mental Health Appointment": "Mental health appt",
            "Referred BAP": "BAP referral"
        })
)
